...
static const char *fonts[]          = { "Segoe UI:size=10" };
static const char dmenufont[]       = "monospace:size=10";
static const char col_gray1[]       = "#1f2937";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#eeeeee";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#3f51b4";
static const char col_float[]       = "#ff0000";
static const char *colors[][4]      = {
	/*                     fg             bg            border     float */
	[SchemeNorm]       = { col_gray3,     col_gray1,    col_gray2, col_float   },
	[SchemeSel]        = { col_gray4,     col_cyan,     col_cyan,  col_float   },
